...
class OnlineCostCoLearner:
    ...
    def run_online_learning(self):
        ...
        if result_top and result_random:
            print(f"\n{'指标':<15} {'40% 最重要的行':<20} {'随机 40% 行':<20} {'改进':<15}")
            print("-"*80)
            ...
            print("\n说明: 越小的 MAE/MSE/RMSE 越好，因此改进百分比表示 40% 最重要的行相对于随机选择提升了多少")
    ...
    def plot_route_importance_comparison(self, route_importances, top_route_indices, random_route_indices):
        ...
        axes[1, 0].set_title('Top 40% Routes Importance Distribution', fontsize=12, fontweight='bold')
        ...
        axes[1, 1].set_title('Random 40% Routes Importance Distribution', fontsize=12, fontweight='bold')
